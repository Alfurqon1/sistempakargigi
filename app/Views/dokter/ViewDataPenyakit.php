...
<?= $this->section('content'); ?>
    ...
    <div class="flex flex-row items-center justify-between py-5">
        <h1 class="font-semibold text-lg">Data Penyakit</h1>
        <a href="<?= base_url('/dokter/tambahPenyakit') ?>" class="bg-primary hover:bg-primary_hover text-white text-lg rounded-full py-4 px-7">Tambah Penyakit</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b">
                ...
                <td class="flex flex-row px-6 py-4 gap-x-4">
                    <a href="<?= base_url('/dokter/detailPenyakit'. $pyt['id_penyakit'])?>">
