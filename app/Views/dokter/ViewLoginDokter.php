...
<body>
   <section class="min-h-screen bg-cover bg-no-repeat bg-center flex justify-center items-center" style="background-image: url(<?= base_url()?>img/login_dokter.jpg);">
        <div class="text-center flex flex-col gap-y-4">
            <h1 class="text-3xl font-bold text-white">Login Dokter</h1>
            ...
            <div class="rounded-3xl w-auto p-10 bg-white shadow-lg">
                ...
                <form action="<?= base_url('loginDokter')?>" method="post" class="flex flex-col gap-y-6">
                 <?= csrf_field(); ?>
                ...
                <div class="flex flex-col justify-center gap-y-2 text-white">
                    <p>atau</p> <a href="<?= base_url('loginPasien')?>"><b>Login Sebagai Pasien</b></a>
                </div>
