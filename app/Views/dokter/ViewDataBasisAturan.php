...
<?= $this->section('content'); ?>
    ...
    <div class="flex flex-row items-center justify-between py-5">
        <h1 class="font-semibold text-lg">Data Basis Aturan</h1>
        <a href="<?= base_url('/dokter/tambahDataBasisAturan') ?>" class="bg-primary hover:bg-primary_hover text-white text-lg rounded-full py-4 px-7">Tambah Basis Aturan</a>
    </div>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-black">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b">
                ...
                <td class="px-6 py-4">
                    <?= $penyakitModel->getNamaPenyakit($atn['id_penyakit'])?>                
                </td>

                <td class="flex flex-row px-6 py-4 gap-x-4">
                    <a href="<?= base_url('/dokter/detailBasisAturan'. $atn['id_penyakit'])?>">
